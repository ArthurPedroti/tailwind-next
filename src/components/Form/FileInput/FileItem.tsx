...
const fileItem = tv({
  slots: {
    ...
    icon: 'rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-900/60 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-error-50 bg-error-100 text-error-600 dark:bg-error-500/30 dark:border-zinc-900/60 dark:text-error-400',
        deleteButton:
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-red-600 dark:text-error-500/80">
              {name}
            </span>
          </div>
